...
class _MyOrderDetailState extends State<MyOrderDetail> {
  ...
  Future orderDetails() {
    return Api.http
        .get("shopping/order/show/$id", queryParameters: {"user_type": Auth.check()! ? 1 : 2})
        .then((response) {
          setState(() {
          ...
          Expanded(
            child: FutureBuilder(
              ...
              builder: (context, AsyncSnapshot? snapshot) {
                ...
                return SingleChildScrollView(child: Column(children: <Widget>[_buildOrdersList(context)]));
              },
            ),
          ),
          SizedBox(height: 8.0),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Container(
                width: 100,
                child: Stack(children: <Widget>[if (product['url'] != null) PNetworkImage(product['url'])]),
              ),
              12.width,
              Column(
                mainAxisAlignment: MainAxisAlignment.start,
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      SizedBox(width: 6),
                      text('\₹ ${product['mrp']}', decoration: TextDecoration.lineThrough, fontSize: 13.0),
                    ],
                  ),
                  text('Quantity' + ' : ' + product['quantity'].toString(), fontSize: 13.0),
                ],
              ).expand(),
            ],
          ),
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        color: AppUtils.setStatusColor(product['deliveryStatus']['name']),
                ...
                child: Column(
                  children: [
                    ...
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: 10, vertical: 3),
                      decoration: BoxDecoration(
                        color: AppUtils.setStatusColor(product['paymentStatus']['name']),
                        borderRadius: BorderRadius.all(Radius.circular(8)),
                      ),
                      child: text(
              ...
              Container(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Order\nStatus', style: TextStyle(fontSize: 14.0), textAlign: TextAlign.center),
                    5.height,
                    Container(
                      padding: EdgeInsets.symmetric(horizontal: 10, vertical: 3),
                      decoration: BoxDecoration(
                        color: AppUtils.setStatusColor(product['status']['name']),
                        borderRadius: BorderRadius.all(Radius.circular(8)),
                      ),
                      child: text(
                        product['status']['name'],
            ...
            Row(
              ...
              children: [
                ...
                text(
                  ...
                  fontSize: 12.0,
                  fontFamily: fontMedium,
                  textColor: AppUtils.setStatusColor(product['returnStatusDetail']['name']),
                  fontweight: FontWeight.w600,
                ),
              ],
            ),
          ...
          Row(
            ...
            mainAxisSize: MainAxisSize.max,
            children: [
              text('Total Coin Used : ', fontSize: 13.0, fontFamily: fontBold, fontweight: FontWeight.w600),
              text(
            ...
            children: [
              if (product['paymentStatus']['id'] == 3)
                Container(
                  ...
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.0), color: colorPrimary),
                  child: text(
                  ...
                  Get.toNamed(
                    '/review-add',
                    arguments: {"editType": product['inReviewList'], "product": product},
                  )!.then((value) {
                    setState(() {
                      orderFuture = orderDetails();
                    });
              ...
              if (product['returnStatus'] != null && product['returnStatus'])
                Container(
                  ...
                  padding: EdgeInsets.symmetric(vertical: 8, horizontal: 8),
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.0), color: greenColor),
                  child: text('Return', textColor: Colors.white, fontSize: 12.0),
                ).onTap(() {
                  Get.toNamed(
                    '/product-return',
                    arguments: {"returnTypes": returnTypes, "orderID": product['orderProductId']},
                  )!.then((value) {
                    setState(() {
                      orderFuture = orderDetails();
                    });
              ...
              if (product['deliveryStatus']['id'] != 5 &&
                ...
                Container(
                  ...
                  child: text('Cancel order', textColor: Colors.white, fontSize: 12.0),
                ).onTap(() {
                  cancelPopUp(product);
                }),
            ],
          ...
          Row(
            ...
            children: [
              if (product['invoiceNumber'] != null)
                Container(
                  padding: EdgeInsets.symmetric(vertical: 8, horizontal: 8),
                  decoration: BoxDecoration(borderRadius: BorderRadius.circular(10.0), color: colorAccent),
                  child: Center(child: text('Download Invoice', textColor: Colors.white, fontSize: 12.0)),
                ).onTap(() {
              ...
              if (product['trackingUrl'] != null)
                Container(
                  ...
                  child: Center(child: text('Track Order', textColor: Colors.white, fontSize: 12.0)),
                ).onTap(() {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                ...
                SizedBox(height: 10),
                Divider(color: textColorSecondary, height: 1, thickness: 0),
                Row(
                  ...
                  children: [
                    Expanded(
                      ...
                      child: GestureDetector(
                        ...
                        child: Icon(UniconsLine.multiply, color: red),
                      ),
                    ),
                    Container(height: 50, child: VerticalDivider(color: textColorSecondary, width: 1)),
                    Expanded(
                      flex: 2,
                      child: GestureDetector(
                        behavior: HitTestBehavior.opaque,
                        ...
                        child: Icon(UniconsLine.check, color: green),
                      ),
                    ),
                  ],
                ),
  ...
  Future getInvoiceUrl(int id) {
    return Api.http
        .get("shopping/order/order-invoice/$id", queryParameters: {"user_type": Auth.check()! ? 1 : 2})
        .then((response) async {
          if (response.data['status']) {
