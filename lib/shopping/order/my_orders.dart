  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: orderType == null
          ? AppBar(
              title: text('Orders'.toUpperCase(), fontweight: FontWeight.bold),
              actions: [buildMLMCart(context)],
            )
          : null,
      body: PaginatedList(
        pageTitle: 'Orders',
    ...
    return InkWell(
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            text(item['orderNo'], fontFamily: fontBold, isLongText: true),
            10.height,

            text(item['date'], fontSize: 14.0),
            10.height,
            text("Status", fontFamily: fontBold, isLongText: true),
            10.height,
            Row(
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          color: AppUtils.setStatusColor(item['paymentType']['name']),
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        padding: EdgeInsets.symmetric(horizontal: 10, vertical: 3),
                        decoration: BoxDecoration(
                          color: AppUtils.setStatusColor(item['paymentStatus']['name']),
                          borderRadius: BorderRadius.all(Radius.circular(8)),
                        ),
                        child: text(
            ...
            text("Total", fontFamily: fontBold, isLongText: true),
            3.height,
            ...
            row_order_detail('Total Selling Price : ', '₹ ${item['totalSellingPrice']}'),
            row_order_detail('Total Taxable Amount : ', '₹ ${item['taxableAmt']}'),
            row_order_detail('Total GST : ', '₹ ${item['totalGst']}'),
            row_order_detail('Delivery Charge : ', '₹ ${item['totalShipping']}'),
            Container(
