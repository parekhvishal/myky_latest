        ...
        child: Column(
          children: <Widget>[
            Container(
              ...
              child: Row(
                children: [
                  Icon(Icons.arrow_back, size: 20).onTap(() {
                    Get.back();
                  }),
                  10.width,
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        prefixIcon: Icon(UniconsLine.search, color: Colors.black54),
                      ...
                      onChanged: (text) {
                        if (text.isNotEmpty) {
                          ...
                          Api.httpWithoutLoader
                              .post('shopping/search-suggestion', data: {"name": _searchController.text})
                              .then((response) {
            ...
            if (error != null && _searchController.text.isNotEmpty) Center(child: Text(error)),
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      Padding(
                        ...
                        child: Icon(UniconsLine.search, size: 16, color: Colors.grey),
                      ),
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: <Widget>[text(capitalize(post['name']), overflow: TextOverflow.ellipsis)],
                        ),
                      ),
                    ],
                  ),
                ...
                child: Container(
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      text('Category', textColor: colorPrimary),
                    ],
                  ),
                ),
              ),
