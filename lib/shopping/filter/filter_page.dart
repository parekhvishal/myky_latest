...
class _FilterPageState extends State<FilterPage> {
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                text('sort', textAllCaps: true, fontFamily: fontSemiBold),
                                IconButton(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                text('Category', textAllCaps: true, fontFamily: fontSemiBold),
                                IconButton(
                                      ...
                                      if (value!) {
                                        setState(() {
                                          if (selectedCategory.length == 0) {
                                            selectedCategory.add({"id": categoryData[index]['id']});
                                          } else {
                                            int i = selectedCategory.indexWhere(
                                              (m) => m["id"] == categoryData[index]['id'],
                                            );
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                text('Gender', textAllCaps: true, fontFamily: fontSemiBold),
                                IconButton(
                                  icon: Icon(UniconsLine.multiply),
                                  onPressed: () {
                                    Navigator.pop(context);
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              decoration: BoxDecoration(
                                                ...
                                                border: Border.all(
                                                  color: genderData[index]['isSelected']
                                                      ? Colors.red
                                                      : Colors.white,
                                                  width: 4.0,
                                                ),
                                            ...
                                            SizedBox(height: 8.0),
                                            text(genderData[index]['name'], fontFamily: fontMedium),
                                          ],
                                        ),
                                      ).onClick(() {
                                        setState(() {
                                          ...
                                          if (value!) {
                                            setState(() {
                                              if (selectedGender.length == 0) {
                                                selectedGender.add({"id": genderData[index]['id']});
                                              } else {
                                                int i = selectedGender.indexWhere(
                                                  (m) => m["id"] == genderData[index]['id'],
                                                );
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                text('Filters', textAllCaps: true, fontFamily: fontSemiBold),
                                IconButton(
                                  icon: Icon(UniconsLine.multiply),
                                  onPressed: () {
                                    Navigator.pop(context);
                                    ...
                                    children: [
                                      if (selectedIndex != null)
                                        Align(
                                          ...
                                          child: text(selectedIndex!['name'], textAllCaps: true),
                                        ),
                                      Expanded(
                                        child: Container(
                                          height: h(100),
  ...
  Widget buildDoneButton(BuildContext context) {
    return Padding(
      ...
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
        children: [
          text('$productCount + Product', textAllCaps: true, fontFamily: fontSemiBold),
          MaterialButton(
            onPressed: () {
              widget.filterData({"sort": selectedShortValue, "filter": selectedFilter});
              Navigator.pop(context);
            },
            elevation: 0,
                                ...
                                subFilter.forEach((singleFilterDetail) {
                                  if (singleFilterDetail['id'] == subFilter[i]['id']) {
                                    ...
                                    if (selectedIndex!['name'] == 'gender') {
                                      fitterList(
                                        selectedList: singleFilterDetail,
                                        addList: selectedFilter['gender'],
                                      );
                                    } else if (selectedIndex!['name'] == 'Price') {
                                      fitterList(
                                        selectedList: singleFilterDetail,
                                        addList: selectedFilter['price'],
                                      );
                                    } else if (selectedIndex!['name'] == 'Discount') {
                                      fitterList(
                                        selectedList: singleFilterDetail,
                                        addList: selectedFilter['discount'],
                                      );
                                    }
                                  }
                                });
                                ...
                                subFilter.forEach((singleFilterDetail) {
                                  if (singleFilterDetail['id'] == subFilter[i]['id']) {
                                    ...
                                    if (selectedIndex!['name'] == 'category') {
                                      fitterList(
                                        selectedList: singleFilterDetail,
                                        addList: selectedFilter['categories'],
                                      );
                                    } else if (selectedIndex!['name'] == 'Rating') {
                                      fitterList(
                                        selectedList: singleFilterDetail,
                                        addList: selectedFilter['ratings'],
                                      );
                                    }
                                  }
                                });
  ...
  Widget buildDynamicCheckboxListTile(int i, setState, {bool isRating = true}) {
    return CheckboxListTile(
      title: text(subFilter[i]['name'].toString(), fontFamily: fontMedium),
      onChanged: (bool? value) {
        subFilter.forEach((singleFilterDetail) {
          if (singleFilterDetail['id'] == subFilter[i]['id']) {
            setState(() {
