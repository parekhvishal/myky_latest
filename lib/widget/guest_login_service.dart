...
class BottomSheetService {
                    ...
                    Form(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          text('Login as a guest', fontFamily: fontBold, fontSize: 14.0),
                          SizedBox(height: 20),
                          formFieldOld(
                            context,
                            'Enter Mobile Number',
                          ...
                          if (this.isOTP) ...[
                            formFieldOld(
                              ...
                              validator: validator.add(
                                key: 'code',
                                rules: [ValidatorX.mandatory(message: "OTP field is required")],
                              ),
  ...
  void sendOTP(BuildContext context, setDialogState) {
    ...
    if (_mobileController.text.isEmpty) {
      AppUtils.showErrorSnackBar("The Mobile number is required");
    } else {
      Api.http
