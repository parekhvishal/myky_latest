...
class TicketDetailsState extends State<TicketDetails> {
                  ...
                  Row(
                    ...
                    children: [
                      IconButton(
                        ...
                        icon: Icon(UniconsLine.trash_alt, size: 30.sp, color: redColor.withOpacity(0.6)),
                      ),
                      10.widthBox,
                      if (_image != null)
                        IconButton(
                          ...
                          icon: Icon(UniconsLine.crop_alt, size: 30.sp, color: white.withOpacity(0.6)),
                        ),
                      10.widthBox,
                      IconButton(
                        onPressed: () {
                        ...
                        icon: Icon(UniconsLine.check, size: 30.sp, color: greenColor),
                      ),
                    ],
                  ),
                  10.heightBox,
        ...
        appBar: AppBar(
          ...
          actions: [
            IconButton(
              ...
              icon: Icon(Boxicons.bx_refresh, size: 25.sp),
            ),
          ],
        ),
        body: Column(
              ...
              child: PaginatedList(
                ...
                apiFuture: (page) async {
                  return await Api.http.post(
                    ...
                    data: {'offlineShopComplaintId': ticketId},
                  );
                },
            ...
            status != 2
                          ...
                          children: [
                            AppTextField(
                              ...
                              decoration: InputDecoration(
                                ...
                                suffixIcon: Icon(Boxicons.bx_send, size: 25.sp, color: colorAccent).onTap(() {
                                ...
                                prefixIcon: Padding(
                                  ...
                                  child: SvgPicture.asset(attach).onTap(() {
                ...
                : Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(color: AppUtils.setStatusColor('closed'), width: 2.w),
    ...
    if (_image != null) {
      return Container(
        ...
        child: Row(
          ...
          children: [
            text("One Photo Attached", textColor: colorAccent, fontFamily: fontSemiBold, fontSize: 15.sp),
            5.widthBox,
            GestureDetector(
              onTap: () {
                setState(() {
              ...
              child: Icon(UniconsLine.times_circle, color: Colors.red, size: 22.sp),
            ),
          ],
        ),
      ).onTap(() {
      ...
      child: Column(
        children: [
          ...
          Row(
            ...
            children: [
              Container(
                decoration: BoxDecoration(color: white, borderRadius: radius(8.r)),
                            ...
                            children: [
                              PNetworkImage(
                                ...
                                showDialog(
                                  ...
                                  context: context,
                                  builder: (_) {
                                    return ImageDialog(url: data['imageUrl']);
                                  },
                                );
                              }),
                              10.heightBox,
            ...
            children: [
              CircleAvatar(
                ...
                child: data['profileImage'] != null
                    ? PNetworkImage(data['profileImage'], fit: BoxFit.cover).cornerRadiusWithClipRRect(30.r)
                    : Image.asset(profileImage, fit: BoxFit.fill).cornerRadiusWithClipRRect(30.r),
              ),
              12.widthBox,
              Container(
                decoration: BoxDecoration(color: colorPrimary.withOpacity(0.2), borderRadius: radius(8.r)),
                padding: EdgeInsets.all(10.sp),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    ...
                    5.heightBox,
                    text(data['createdAt'], fontSize: 12.sp, fontFamily: fontBold, textColor: colorAccent),
                  ],
                ),
  ...
  void _loadTicketDetails(int ticketId) {
    Api.http.post('member/offline-store-complaint/messages', data: {'offlineShopComplaintId': ticketId}).then(
      (response) {
      ...
      Api.httpWithoutLoader
          ...
          .then((response) {
            ...
            if (response.data['status']) {
              ...
              AppUtils.showSuccessSnackBar(response.data['message'], secondsToDisplay: 1);
              screenShot = null;
              _image = null;
              setState(() {
                _ticketDetailPaginatedListKey.currentState!.refresh();
