                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    ...
                                    TextFormField(
                                      ...
                                      readOnly: true,
                                      onTap: () => _showBottomSheetDOBPicker(context),
                                      validator: (value) {
                                    ...
                                    Container(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          10.heightBox,
                                          _buildPaymentDetailRow("Account Number :", "115410801200120"),
                                          10.heightBox,
                                          ...
                                          Center(
                                            child: GestureDetector(
                                              onTap: () {
                                                FileDownloadCtrl().download(qrImage!, context);
                                              },
                                    ...
                                    const SizedBox(height: 10.0),
                                    text('Payment Screenshot ', fontweight: FontWeight.bold),
                                    const SizedBox(height: 10.0),
                                    Stack(
                                              ...
                                              if (!uploadingImage5)
                                                _image5 != null
                                                    ...
                                                    : Center(
                                                        child: SizedBox(
                                                          height: 200,
                                                          child: Center(child: text('Attach screenshot')),
                                                        ),
                                                      ),
                                              if (uploadingImage5)
                                                const SizedBox(
                                    ...
                                    CustomButtonOld(
                                      ...
                                      onPressed: () async {
                                        if (_registerFormKey.currentState!.validate()) {
                                          ...
                                          if (_image5 == null) {
                                            AppUtils.showErrorSnackBar("Please attach payment proof");

                                            return;
                                          }
                                          if (_profileImage == null) {
                                            AppUtils.showErrorSnackBar("Please attach profile image");
                                          ...
                                          try {
                                            ...
                                            imageMap.forEach((image, label) {
                                              if (image != null) {
                                                uploadTasks.add(uploadImage(image, label));
                                              }
                                            });

                                            if (_profileImage != null) {
                                              uploadTasks.add(
                                                uploadImage(_profileImage, 'Profile Image').then((img) {
                                                  profileImage = img;
                                                }),
                                              );
                                            }
                                            ...
                                            if (_image5 != null) {
                                              uploadTasks.add(
                                                uploadImage(_image5, 'Payment Proof').then((img) {
                                                  paymentProof = img;
                                                }),
                                              );
                                            }
                                            ...
                                            final uploadedImages = await Future.wait(uploadTasks);

                                            // Add regular images to subImagesList
                                            subImagesList.addAll(uploadedImages.whereType<String>());
                                            ...
                                            Map<String, dynamic> sendData = {
                                              ...
                                              "profile_image": profileImage, // Profile Image
                                              "payment_proof": paymentProof, // Payment Proof
                  ...
                  children: <Widget>[
                    if (!uploadingProfile)
                      _profileImage != null
                          ? ClipRRect(
                              ...
                              child: Image.file(_profileImage!, width: 100, height: 100, fit: BoxFit.contain),
                            )
                          : SvgPicture.asset(
                    ...
                    if (uploadingProfile)
                      SizedBox(
                        ...
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[Text(progressStringProfile), const CircularProgressIndicator()],
                        ),
                      ),
                  ],
                ),
    ...
    return GestureDetector(
      onTap: () {
        if (_nameController.text.isNotEmpty &&
          ...
          AppUtils.showErrorSnackBar('Kindly submit the necessary details as mentioned above."');
        }
      },
      child: Container(
        decoration: BoxDecoration(
          ...
          boxShadow: const [
            ...
            BoxShadow(color: Colors.white10, offset: Offset(-4, -4), blurRadius: 10),
          ],
        ),
        child: const Padding(
    ...
    return Row(
      children: [
        ...
        IconButton(
          ...
          onPressed: () {
            Clipboard.setData(const ClipboardData(text: "9656703607@okbizaxis"));
