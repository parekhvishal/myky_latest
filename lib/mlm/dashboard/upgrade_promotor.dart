            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  10.heightBox,
                  _buildPaymentDetailRow("Account Name :", "Luck and Belief Marketing Solutions Pvt Ltd"),
                  10.heightBox,
              ...
              child: CustomButtonOld(
                ...
                onPressed: () async {
                  if (true) {
                    ...
                    if (_image != null) {
                      receiptImage = await Vapor.upload(_image!);
                    }
                    setState(() {
                      uploadingImage = false;
                    });

                    Map sendData = {'payment_proof': receiptImage};
                    ...
                    Api.http
                        ...
                        .catchError((errors) {
                          if (errors.response.statusCode == 422) {
                            AppUtils.showErrorSnackBar(errors.response.data['errors']['image'][0]);
                          }
                        });
                  }
                },
            ...
            children: <Widget>[
              if (!uploadingImage)
                _image != null
                    ...
                    : Center(
                        child: SizedBox(height: 200, child: Center(child: text('Attach screenshot'))),
                      ),
              if (uploadingImage)
                const SizedBox(
                  height: 200,
