...
class _VendorWalletTransactionNewState extends State<VendorWalletTransactionNew> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Vendor Wallet Transaction")),
      body: CustomContainer(
        child: Column(
          mainAxisAlignment: MainAxisAlignment.start,
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            if (vendorWalletBalance != null) ...[walletBalance(), 12.heightBox],
  ...
  dateSelectionFilter(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        text("to", textColor: colorPrimary, fontFamily: fontBold).marginSymmetric(horizontal: 6.w),
      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.wallet, size: 17.sp, color: colorPrimary),
          ),
          12.widthBox,
          Column(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              text("Wallet Balance", fontFamily: fontMedium, fontSize: 12.sp),
              5.heightBox,
              text("$vendorWalletBalance", fontFamily: fontBold, textColor: colorPrimary, fontSize: 16.sp),
            ],
          ).expand(),
        ],
      ),
      ...
      child: Column(
        ...
        children: [
          Row(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Icon(LineIcons.calendar, color: colorPrimary, size: 28.sp),
              8.widthBox,
              Column(
                mainAxisAlignment: MainAxisAlignment.start,
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [text(item['date'])],
              ).expand(),
              Container(
          ...
          8.heightBox,
          rowHeading("Amount", '\₹ ${item['amount']}'),
          4.heightBox,
          rowHeading("Profit Shared", '\₹ ${item['companyCharge']}'),
          4.heightBox,
          rowHeading("GST Amount", '\₹ ${item['gstAmount']}'),
          4.heightBox,
          rowHeading("Payable Amount", '\₹ ${item['total']}'),
          4.heightBox,
          RichText(
            text: TextSpan(
              text: "Remarks :",
              style: const TextStyle(color: Colors.black, fontSize: 15, fontFamily: fontRegular),
              children: [
                WidgetSpan(
                  child: Padding(padding: EdgeInsets.only(right: 5.w)),
                ),
                TextSpan(
                  // text: 'Offline Store purchase from NANDHANA(100017) of à¤° 4366',
                  text: item['remark'],
                  style: TextStyle(fontSize: 14, color: colorPrimary, fontFamily: fontBold, height: 1.5),
                ),
              ],
            ),
          ).marginSymmetric(horizontal: 12.w),
