...
class SelfExplanatoryVideo extends StatefulWidget {
  ...
  @override
  _SelfExplanatoryVideoState createState() => _SelfExplanatoryVideoState();
}

class _SelfExplanatoryVideoState extends State<SelfExplanatoryVideo> {
  ...
  void fetchVideos() {
    Api.http.get('member/self-explanatory-video').then((response) {
